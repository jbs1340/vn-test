...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'admin-style', get_template_directory_uri() . '/admin-style.css', false, '' );
    ...
    wp_enqueue_script( 'bootstrap-formhelpers-phone', get_template_directory_uri() . '/js/bootstrap-formhelpers-phone.js', array(), '20151215', true );
    //wp_enqueue_script( 'pdfobject-min', get_template_directory_uri() . '/js/pdfob.min.js', array(), '20151215', true );
    wp_enqueue_script( 'adminjs', get_template_directory_uri() . '/admin-script.js', array(), '20151215', true );
