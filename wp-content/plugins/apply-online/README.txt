...
* For more information go to FAQs section in your WordPress admin panel under **Apply Online** section.
...
= Method 2 =
1. After installation, locate the menu **Apply Online** in admin panel and create few ads there.
1. From Wordpress admin panel, add a page i. e. **Careers** or **New Admissions**
1. Place **[aol]** shortcode into this page and let the magic begin.
...
== Changelog ==
= 1.9.93 =
* Fixed: Attachment link in received applications.
* Fixed: "Closed Application alert" option in Settings.
* Fixed: "Application submission message" option in Settings.
