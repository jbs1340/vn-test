...
class Applyonline {
	...
	tgmpa( $plugins, $config );
        ...
        public function register_aol_post_types(){
            ...
            $labels=array(
                'add_new'  => __('Create Job', 'ApplyOnline' ),
                'add_new_item'  => __('New Job', 'ApplyOnline' ),
                'edit_item'  => __('Edit Job', 'ApplyOnline' ),
                'all_items' => __('Job List', 'ApplyOnline' ),
                //'menu_name' => __('Apply Online', 'ApplyOnline' )
            );
            $args=array(
                'label' => __( 'Create Job', 'ApplyOnline' ),
                'labels'=> $labels,
                'show_in_menu'  => true,
                'description' => __( 'Create Job' ),
            ...
            $args=array(
                'label' => __( 'Candidates', 'ApplyOnline' ),
                'labels' => $lables,
                'show_ui'           => true,
                'public'   => false,
